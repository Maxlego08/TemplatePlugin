...
public class ItemDecoder {
	...
	public static String serializeItemStack(ItemStack paramItemStack)
	{
		...
		try
		{
			...
			Object localObject2 = getOBClass("inventory.CraftItemStack").getMethod("asNMSCopy", new Class[] { ItemStack.class }).invoke(null, new Object[] { paramItemStack });
			getNMSClass("ItemStack").getMethod("save", new Class[] { localClass }).invoke(localObject2, new Object[] { localObject1 });
			localByteArrayOutputStream = new ByteArrayOutputStream();
			getNMSClass("NBTCompressedStreamTools").getMethod("a", new Class[] { localClass, OutputStream.class }).invoke(null, new Object[] { localObject1, localByteArrayOutputStream });
		}
	...
	public static ItemStack deserializeItemStack(String paramString)
	{
		...
		try
		{
				localObject1 = getNMSClass("NBTCompressedStreamTools").getMethod("a", new Class[] { InputStream.class }).invoke(null, new Object[] { localByteArrayInputStream });
			...
			else  if (getNMSVersion() == 1.13D){
				localObject2 = localClass2.getMethod("a", new Class[] { localClass1 }).invoke(null, new Object[] { localObject1 });
			}	
			else
			{
				localObject2 = localClass2.getMethod("createStack", new Class[] { localClass1 }).invoke(null, new Object[] { localObject1 });
			}
			localItemStack = (ItemStack)getOBClass("inventory.CraftItemStack").getMethod("asBukkitCopy", new Class[] { localClass2 }).invoke(null, new Object[] { localObject2 });
		}
		catch (Exception localException)
		{
			localException.printStackTrace();
