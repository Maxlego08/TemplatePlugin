...
import fr.maxlego08.hopper.zcore.utils.nms.NMSUtils;
...
public enum Message {
	...
	DESCRIPTION_RELOAD("Permet de recharger les fichiers de configuration."),
	DESCRIPTION_GIVE("Permet de donner un hopper à un joueur."), 
	DESCRIPTION_CONVERT("Permet de convertir les données."), 
	DESCRIPTION_INFO("Permet d'avoir les informations sur les hoppers"), 
	RELOAD("§aVous venez de recharger les fichiers de configuration du plugin."),
	
	
	GIVE_SENDER("§aVous venez de donner un hopper à §f%player%§a."),
	GIVE_PLAYER("§aVous venez de recevoir un §6| §fHopper §6|§a."),
	GIVE_OFFLINE("§cLe joueur §f%player% §cdoit être en ligne pour recevoir un hopper."),
	
	ACTION_PLACE("§aVous venez de placer un §6| §fHopper §6|§a."),
	ACTION_BREAK("§aVous venez de casser un §6| §fHopper §6|§a."),
	
	CONVERT_ALREADY("§cLa conversion est déjà en cours."),
	CONVERT_FILE("§cImpossible de trouver le fichier §fdata.db§c. Veuillez mettre le fichier dans le dossier du plugin."),
	CONVERT_START("§aVous venez la conversion des données."),
	CONVERT_END("§aVous venez d'ajouter §fx%count% §2Hopper§a."), 
	
	INFORMATIONS(
			"§7Nombre de hopper§8: §f%hopperCount%",
			"§7Nombre de hopper actif§8: §f%hopperActiveCount%"
			),
