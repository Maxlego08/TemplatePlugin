...
import fr.maxlego08.hopper.zcore.utils.commands.Tab;

public abstract class VCommand extends Arguments {

	protected final HopperPlugin plugin;
	 ...
	 * @param plugin
	 */
	public VCommand(HopperPlugin plugin) {
		super();
		this.plugin = plugin;
	}
	...
	public CommandType prePerform(HopperPlugin plugin, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(HopperPlugin plugin);
	 ...
	 * @return
	 */
	public List<String> toTab(HopperPlugin plugin, CommandSender sender2, String[] args) {
		return null;
	}
