package fr.maxlego08.timer.command;
...
import fr.maxlego08.timer.zcore.enums.Message;
import fr.maxlego08.timer.zcore.enums.Permission;
import fr.maxlego08.timer.zcore.utils.commands.Arguments;
import fr.maxlego08.timer.zcore.utils.commands.CollectionBiConsumer;
import fr.maxlego08.timer.zcore.utils.commands.CommandType;
import fr.maxlego08.timer.zcore.utils.commands.Tab;

public abstract class VCommand extends Arguments {

	protected final TimerPlugin plugin;
	 ...
	 * @param plugin
	 */
	public VCommand(TimerPlugin plugin) {
		super();
		this.plugin = plugin;
	}
	 ...
	 * @return
	 */
	public CommandType prePerform(TimerPlugin plugin, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(TimerPlugin plugin);
	 ...
	 * @return
	 */
	public List<String> toTab(TimerPlugin plugin, CommandSender sender, String[] args) {
