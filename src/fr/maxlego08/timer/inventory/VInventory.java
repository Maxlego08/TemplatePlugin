package fr.maxlego08.timer.inventory;
...
import fr.maxlego08.timer.exceptions.InventoryOpenException;
import fr.maxlego08.timer.zcore.utils.ZUtils;
import fr.maxlego08.timer.zcore.utils.builder.ItemBuilder;
import fr.maxlego08.timer.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.timer.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected TimerPlugin plugin;
	...
	protected InventoryResult preOpenInventory(TimerPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(TimerPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, TimerPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, TimerPlugin plugin, Player player) {
	}
